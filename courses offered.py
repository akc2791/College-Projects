...
def involved(courses, person):
    ...
    for hexamester in courses:
        for course in courses[hexamester]:
            for detail in courses[hexamester][course]:
                if person == courses[hexamester][course][detail]:
                    if hexamester in course_list:
                        course_list[hexamester].append(course)
                    else:
                        course_list[hexamester]= [course]
    return course_list
